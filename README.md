...
# 操作説明  
<img src="操作説明画像.png" width="750" alt="alt text">
...
<img src="デバフ表.png" width="1000" alt="alt text">  

### 回転数が上昇することでスコアに倍率がかかり、より高スコアを目指せます。  
#### y=*スコア倍率*  
#### <img src="関数グラフ.png" width="400" alt="alt text">　X=*回転数*   
...
### 投球時確率で  
## 1 ストレートボール  
![alt text](ストレートボール.gif)
## 2 ナックルボール  
![alt text](ナックルボール.gif)
## 3 W（ホワイト）ボール 
![alt text](W（ホワイト）ボール.gif)
## 4 ヴァニッシュボール  
![alt text](ヴァニッシュボール.gif)
## 5 スライダー  
![alt text](スライダー.gif)
## 6 スローボール  
![alt text](スローボール.gif)
...
<details open>
<summary>下記はHit判定と計算コードです。</summary>
...
<img src="画像.png" width="500" alt="alt text">  
